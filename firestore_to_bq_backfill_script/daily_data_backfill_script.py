...
#   "2025-07-26", "2025-07-27", "2025-07-28",
  ...
  "2025-07-31","2025-08-01","2025-08-02","2025-08-03","2025-08-04","2025-08-05","2025-08-06",
...
def process_data(date):
    ...
    created_at_end = created_at_start.replace(hour=23, minute=59, second=59, microsecond=999999)
    ...
    print(f"Inserted full data for date: {date}")
